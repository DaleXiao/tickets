...
const DICT: Dicts = {
  zh: {
    ...
    "field.time": "时间",
    "field.year": "首映年份",
    "field.year.placeholder": "如 2000，留空自动检索",
    "field.quote": "经典台词",
    "field.quote.placeholder": "≤10 字，留空自动检索",
    "field.optional": "选填",
  ...
  en: {
    ...
    "field.date": "Date",
    "field.time": "Time",
    "field.year": "Premiere year",
    "field.year.placeholder": "e.g. 2000, blank = auto",
    "field.quote": "Classic quote",
    "field.quote.placeholder": "short line, blank = auto",
